...
UPSTREAM_COMMIT="93d13fb690db4581768389450fb639822ae88333"
...
allowed_path() {
  case "$1" in
    ...
    tests/*) return 0 ;;
    input.cpp|input.h|joymapping.cpp|main.cpp|menu.cpp|scheduler.cpp|user_io.cpp|user_io.h|osd.cpp|video.cpp|video.h) return 0 ;;
  esac
  return 1
}
