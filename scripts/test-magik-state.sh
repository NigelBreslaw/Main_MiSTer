...
awk '
  /case MENU_GENERIC_MAIN2:/ { in_render=1 }
  ...
  /case MENU_GENERIC_MAIN3:/ { in_render=0; in_action=1 }
...
grep -q 'video_reinit_attempt' "$ROOT/video.cpp"
grep -q 'video_output_apply' "$ROOT/video.cpp"
grep -q 'hdmi_status_interrupt' "$ROOT/video.cpp"
grep -q 'launcher_pid=%d main_generation=%lu owner=%s owner_epoch=%llu' "$ROOT/support/mister_magik/launcher.cpp"
grep -q 'rename(temporary, s_status_path)' "$ROOT/support/mister_magik/launcher.cpp"
grep -q 'fsync(fileno(f))' "$ROOT/support/mister_magik/launcher.cpp"
...
grep -q 'ts_boot_us' "$ROOT/support/mister_magik/launcher.cpp"
grep -q 'main_process_entry' "$ROOT/support/mister_magik/launcher.cpp"
grep -q 'return_command_received' "$ROOT/support/mister_magik/launcher.cpp"
grep -q 'launcher_executable_ready' "$ROOT/support/mister_magik/launcher.cpp"
grep -Fq 'access(path, R_OK | X_OK)' "$ROOT/support/mister_magik/launcher.cpp"
grep -q 'launcher_exec_begin' "$ROOT/support/mister_magik/launcher.cpp"
grep -q 'ioctl(tty_fd, TIOCSCTTY, 0)' "$ROOT/support/mister_magik/launcher.cpp"
grep -q 'execl("/bin/bash", "bash", s_script_path, NULL)' "$ROOT/support/mister_magik/launcher.cpp"
! grep -q '/sbin/agetty' "$ROOT/support/mister_magik/launcher.cpp"
