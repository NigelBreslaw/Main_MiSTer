...
static const char s_latch_rbf_path[] = "/media/fat/mister-magik/experiments/menu-magik-vblank-latch.rbf";
...
static const char s_artifact_verify_command[] =
	"set -e; "
	"meta=/media/fat/mister-magik/mister_magik_scanout_slots.metadata.txt; "
	"rbf_meta=/media/fat/mister-magik/experiments/menu-magik-vblank-latch.metadata.txt; "
	"module=/media/fat/mister-magik/mister_magik_scanout_slots.ko; "
	"rbf=/media/fat/mister-magik/experiments/menu-magik-vblank-latch.rbf; "
	"main=/media/fat/MiSTer_MagiK; "
	"test -r \"$meta\" -a -r \"$rbf_meta\" -a -r \"$module\" -a -r \"$rbf\" -a -r \"$main\"; "
	"module_expected=$(sed -n 's/^module_sha256=//p' \"$meta\"); "
	"main_expected=$(sed -n 's/^main_binary_sha256=//p' \"$meta\"); "
	"rbf_expected=$(sed -n 's/^rbf_sha256=//p' \"$meta\"); "
	"test ${#module_expected} -eq 64 -a ${#main_expected} -eq 64 -a ${#rbf_expected} -eq 64; "
	"case \"$module_expected$main_expected$rbf_expected\" in *[!0-9a-f]*) exit 1;; esac; "
	"test \"$(sha256sum \"$module\" | awk '{print $1}')\" = \"$module_expected\"; "
	"test \"$(sha256sum \"$main\" | awk '{print $1}')\" = \"$main_expected\"; "
	"test \"$(sha256sum \"$rbf\" | awk '{print $1}')\" = \"$rbf_expected\"; "
	"grep -qx 'platform_contract_sha256=8481c082c327c2892bf0fd64a68195472d4336723f6ab467a611655f949b1faf' \"$meta\"; "
	"grep -qx 'source_sha256=12ec95c6ea9b438c01a747e222a1535411b2de572105166345c476cdeca4c8e7' \"$meta\"; "
	"grep -qx 'source_dirty=0' \"$meta\"; "
	"grep -qx 'magik_revision=4e08fb4e8125f865d10167d4c9d3fd87815f4f11' \"$meta\"; "
	"grep -qx 'menu_revision=cf4dfdee516fcaa6952bdd9fb47154e96c28567e' \"$meta\"; "
	"grep -qx 'fpga_patch_sha256=4bdd2bcee724bb988ab6a975c2532ccc39a4e2b5686fac6fe4c88528f9c55ba6' \"$meta\"; "
	"grep -qx 'latch_rtl_sha256=b810de3fdffbe79b8496e7eaa3967b07f6aa70a3d78dabb41c6428d72d994b1a' \"$meta\"; "
	"grep -qx 'fpga_build_date=260711' \"$meta\"; "
	"grep -qx 'rbf_sha256=69e0e312b226c004bfe7fced2cc1145954efa1110cee7a0f58de1528d52627a1' \"$meta\"; "
	"grep -qx 'magik_commit=4e08fb4e8125f865d10167d4c9d3fd87815f4f11' \"$rbf_meta\"; "
	"grep -qx 'platform_contract_sha256=8481c082c327c2892bf0fd64a68195472d4336723f6ab467a611655f949b1faf' \"$rbf_meta\"; "
	"grep -qx 'source_commit=cf4dfdee516fcaa6952bdd9fb47154e96c28567e' \"$rbf_meta\"; "
	"grep -qx 'build_date=260711' \"$rbf_meta\"; "
	"grep -qx 'rbf_sha256=69e0e312b226c004bfe7fced2cc1145954efa1110cee7a0f58de1528d52627a1' \"$rbf_meta\"";
