...
int main()
{
	...
	assert(!magik_launcher_return_spawn_pending("menu-magik-vblank-latch.rbf", "/media/fat/mister-magik/experiments/menu-magik-vblank-latch.rbf"));
	...
	assert(magik_launcher_return_spawn_pending("menu.rbf", "/media/fat/menu.rbf"));
